...
import { MapPin, Search, Layers, Filter, Ruler, Building, Users, DollarSign, TrendingUp, ShoppingBag } from "lucide-react";
...
const MapAnalysisStep = ({ formData, updateFormData }: MapAnalysisStepProps) => {
  ...
  const startAnalysis = () => {
    // In a real app, this would call an API to analyze the location
    ...
    // For the demo, we'll just update some of the metrics randomly
    setMetrics(prev => 
      prev.map(metric => ({
        ...metric,
